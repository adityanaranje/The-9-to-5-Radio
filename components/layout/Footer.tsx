    ...
    <footer className="border-t border-white/5 bg-ink">
      <div className="mx-auto max-w-7xl px-6 md:px-10 py-12 md:py-16">
        <div className="grid md:grid-cols-3 gap-10 md:gap-16">
          ...
          <div>
            <h4 className="text-xs font-bold tracking-[0.2em] text-white/20 uppercase mb-4">Explore</h4>
          ...
          <div>
            <h4 className="text-xs font-bold tracking-[0.2em] text-white/20 uppercase mb-4">Disclaimer</h4>
